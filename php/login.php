...
if($_POST){
  ...
  if(count($errores)==0){
    ...
    if(usuario==null){
      ...
      if(password_verify($usuario["password"], $_POST["password"])==false){
        $errores["password"]="datos invalidos...";
      }
      else {
...
<body>
  <div class="container-fluid m-0 p-0">
    ...
    <div id="formContent">
      ...
      <!-- Login Form -->
      <form>
        <input type="text" id="login" class="fadeIn second" name="login" placeholder="login" value="<?=isset($errores['email'])? "":old('email') ;?>">
